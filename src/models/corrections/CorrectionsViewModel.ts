...
class CorrectionsViewModel implements ICorrectionsViewModel {
    private _filter: any;
    ...
    private getFilter(): any {
        ...
        if (!this._filter.status) {
            this._filter.status = iqs.shell.CorrectionStatus.Requested;
        }
...
angular.module('iqsCorrections.ViewModel', ['iqsCorrections.Data'])
    .service('iqsCorrectionsViewModel', CorrectionsViewModel);
